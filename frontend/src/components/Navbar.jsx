...
import { authActions } from "../pages"; // ✅ import slice actions
...
const Navbar = () => {
  ...
  return (
    // Wrapper div reserves height for navbar
    <div className="h-14">
      <nav className="fixed top-0 left-0 w-full bg-gray-900 h-14 flex items-center justify-between px-6 shadow-md z-50">
        ...
        <ul className="hidden md:flex gap-6 text-white items-center">
          ...
          <Link className="cursor-pointer hover:text-blue-400" to={"/todo"}>Your To-Do</Link>
